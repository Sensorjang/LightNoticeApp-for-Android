package com.dingyi.codenote.module;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.dingyi.codenote.module.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.dingyi.codenote.module.GlideOptions().apply(toSet));
    }
  }
}
